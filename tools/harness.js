...
;({
  ...
  CORE, GRID, FLOW, UPGRADE, SPECIALS, PRIORITY, TARGETS, OVERLOAD, UNLOCK, BOSS_EVERY,
  START_MATTER, BUILD_TIME, FIRST_BUILD_TIME, TYPE_CAP, GUARD_REDUCTION, DRAFT_SIZE, CARD_MAX,
